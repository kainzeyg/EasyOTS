...
4. Замен вывод уведомлений через класс **toast**;
5. Favicon и Logo могут быть заменены на любые другие через их замену в */static* или через *.env*, подробности ниже.
...
#### Уведомления 
![image](https://github.com/user-attachments/assets/15a6d25d-21cc-47b9-b945-0c3448503988)

---

### **Описание всех API-методов с учётом добавленного функционала для файлов:**
